...
void AGalaga_USFX_LAB02GameMode::BeginPlay()
{
    ...
    //*************  ITERATOR SAPWN DE NAVES DE FLOTAS  **********************

    FVector ubicacionNavesIterator = FVector(-2500.0f, -1000.0f, 200.0f);
    FVector ubicacionNavesIterator2 = FVector(-2500.0f, -700.0f, 200.0f);
    FVector ubicacionNavesIterator3 = FVector(-2500.0f, -400.0f, 200.0f);
    FVector ubicacionNavesIterator4 = FVector(-2500.0f, -100.0f, 200.0f);
    FVector ubicacionNavesIterator5 = FVector(-2500.0f, 200.0f, 200.0f);

    FRotator rotacionNavesIterator = FRotator(0.0f, 0.0f, 0.0f);

    NaveIterator = GetWorld()->SpawnActor<AEnemigaIterator>(ubicacionNavesIterator, rotacionNavesIterator);
    NaveIterator2 = GetWorld()->SpawnActor<AEnemigaItertor2>(ubicacionNavesIterator2, rotacionNavesIterator);
    NaveIterator3 = GetWorld()->SpawnActor<AEnemigaIterator3>(ubicacionNavesIterator3, rotacionNavesIterator);
    NaveIterator4 = GetWorld()->SpawnActor<AEnemigaIterator4>(ubicacionNavesIterator4, rotacionNavesIterator);
    NaveIterator5 = GetWorld()->SpawnActor<AEnemigaIterator5>(ubicacionNavesIterator5, rotacionNavesIterator);
